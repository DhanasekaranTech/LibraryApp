...
export const viewProfile = async (req: Request, res: Response) => {
  try {
    ...
    return res.json({ message: "can't get user" });
  }
};
...
// const userID = req.params;
//     const userBookRepository = AppDataSource.getRepository(UserBook);
//     const userBooks = await userBookRepository.findOne({
...
//    // const usernameID = parseInt(usernameIDstr, 10);
...
//       relations: ["User"] // Adjust this if you have relations you want to load
//     });
